...
export default function BundesligaDuelDetailPage() {
  ...
  async function load() {
    ...
    if (duelError || !duelData) {
      setMessage('Duell wurde nicht gefunden.')
      setLoading(false)
      return
    }
            ...
            >
              ...
              <div style={{ textAlign: 'center' }}>
                ...
                <div style={subtitleStyle}>
                  Bundesliga · Spieltag {duel?.matchday}
                </div>
              </div>
...
const duelHeaderStyle: React.CSSProperties = {
  ...
  boxShadow: '0 16px 34px rgba(22,163,74,0.14)',
  marginBottom: 24,
}
